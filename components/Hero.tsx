      ...
      <div style={{
        ...
        <div>
          ...
          <div style={{ marginTop: 24, display: 'flex', gap: 22, flexWrap: 'wrap', fontSize: 14 }}>
            <a className="tm-link" href={`https://${J.social.github}`} target="_blank" rel="noopener" style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
            ...
            <a className="tm-link" href={`https://${J.social.linkedin}`} target="_blank" rel="noopener" style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
