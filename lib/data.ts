export const JARED = {
  ...
  featured: [
    ...
    },
    {
      ...
      stack: ["SwiftUI", "Swift Concurrency", "Supabase"],
  ...
  secondary: [
    ...
    },
    {
      ...
      stack: ["Next.js 16", "React 19", "Supabase", "Vercel", "Turborepo"],
    ...
    },
    {
      ...
      stack: ["Swift", "Kotlin", "TypeScript", "Agentic harness"],
      links: [{ label: "GitHub", url: "https://github.com/jaredmoskowitz/nl-native" }],
    },
    {
      name:  "Captain",
      tag:   "Pirate-guided task orchestration for AI coding agents.",
      desc:  "A state machine skill for AI coding agents that breaks any complex task into lettered nodes, tracks progress on an ASCII helm, checkpoints to git at every step, and puts you in control of when to review, rewind, or redirect.",
      stack: ["TypeScript", "Agentic harness"],
      links: [{ label: "GitHub", url: "https://github.com/jaredmoskowitz/captain" }],
    },
    {
      name:  "VeryLegit Marketplace",
      tag:   "Productivity and personality plugins for AI coding agents.",
      desc:  "A curated plugin marketplace for AI coding agents. Skills include captain (task orchestration), debate (adversarial plan review), wtf (angry quick questions), tldr (brutal simplification), bear-notes, iOS simulator control, and more.",
      stack: ["TypeScript", "Agentic harness"],
